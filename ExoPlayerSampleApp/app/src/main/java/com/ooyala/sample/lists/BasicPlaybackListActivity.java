...
public class BasicPlaybackListActivity extends Activity implements OnItemClickListener {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    selectionMap.put("MS", new PlayerSelectionOption("1uczVsNTE6v894WfD2TSY7qmDSQdGr73", "tsbmYyOjRH6dK3rmGxeTP2uleUj_", "http://www.ooyala.com", OoyalaSkinPlayerActivity.class));
selectionMap.put("MS 40eW", new PlayerSelectionOption("40eW9wNTE61KjnXxx_jw_GbAv4ZdusjN", "tsbmYyOjRH6dK3rmGxeTP2uleUj_", "http://www.ooyala.com", OoyalaSkinPlayerActivity.class));
